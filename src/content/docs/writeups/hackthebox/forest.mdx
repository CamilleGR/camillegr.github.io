...
Ensuite, nous n'avons pas encore tous les droits sur le domaine. Nous allons simplement écrire un nouveau DACL pour nous donner les droits de faire un DCSync et ainsi récupérer le hash du mot de passe de l'administrateur pour avoir les privilèges systèmes sur la machine FOREST :
